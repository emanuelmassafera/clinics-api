...
import DentalClinicsRepository from '../../../../src/infra/database/repositories/dental-clinics-repository';
import testEnv from '../../../utils/test-env';

const makeSut = (): DentalClinicsRepository => new DentalClinicsRepository();

describe('DentalClinicsRepository', () => {
  beforeAll(async () => {
